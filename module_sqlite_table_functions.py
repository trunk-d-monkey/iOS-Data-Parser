...
def insert_zrt_locations(of_db, of_log):
	...
	sqlquery = """INSERT INTO _device_locations (Z_ENT, Z_OPT, ZSIGNALENVIRONMENTTYPE, ZTYPE, 
				ZALTITUDE, ZCOURSE, ZHORIZONTALACCURACY, ZHACCURACYUNITS, ZLATITUDE, ZLONGITUDE, ZSPEED, ZTIMESTAMP)
				SELECT Z_ENT, Z_OPT, ZSIGNALENVIRONMENTTYPE, ZTYPE, ZALTITUDE, ZCOURSE, ZHORIZONTALACCURACY, "Meters", 
